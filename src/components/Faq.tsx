export function Faq() {
    return (
        <section className="flex flex-col px-8 xl:px-[25rem] lg:px-[10rem] py-12 mt-8 lg:mt-0 rounded-lg bg-white">
            <h2 className="text-3xl md:text-4xl lg:text-5xl mb-12">FAQs</h2>

            <div className="flex flex-wrap gap-4">
                <div className="flex-[1_0_150px] p-2">
