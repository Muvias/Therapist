    ...
    return (
        <section className="flex justify-center items-center py-8 px-8 md:px-16 bg-white md:gap-16">
            <div className="md:max-w-[40%] lg:max-w-[30%]">
                ...
                <p className="text-lg">Bem-vindo ao meu site! Sou especialista em terapia cognitivo-comportamental e estou aqui para ajudá-lo a alcançar seus objetivos e superar desafios emocionais.</p>
            </div>
